            ...
            return __awaiter$5(this, void 0, void 0, function* () {
                ...
                if (current) {
                    ...
                    if (manifest.push) {
                        ...
                        const response = yield this.scope.fetch(req);
                        if (!response.ok) {
        ...
        handleMessage(msg, from) {
            return __awaiter$5(this, void 0, void 0, function* () {
                if (isMsgCheckForUpdates(msg)) {
                    ...
                    yield this.reportStatus(from, this.handleRequestedPush(msg.subscription), msg.statusNonce);
                }
            });
        }
        handleRequestedPush(subscription) {
            return __awaiter$5(this, void 0, void 0, function* () {
                try {
                    yield this.localStorage.open();
                    if (subscription) {
                        yield this.localStorage.setItem('subscription', JSON.stringify(subscription));
                    }
                    else {
                        yield this.localStorage.removeItem('subscription');
                    }
                }
                catch (e) {
                    this.debugger.log(e);
        ...
        handlePushStatus() {
            return __awaiter$5(this, void 0, void 0, function* () {
                try {
                    ...
                    const pushState = yield pushManager.permissionState({ userVisibleOnly: true });
                    if (pushState === 'granted') {
                        const subscription = yield pushManager.getSubscription();
                        if (subscription) {
                            const oldRawSubscription = yield this.localStorage.getItem('subscription');
                            yield this.localStorage.setItem('subscription', JSON.stringify(subscription));
                            if (oldRawSubscription) {
                                ...
                                if (oldSubscription.endpoint !== subscription.endpoint) {
                                    yield this.onPushSubscriptionChange({
